 ...
 *
 */
public class AutoChevalPosition2CenterFace extends CommandGroup {
    
    public  AutoChevalPosition2CenterFace() {
        // Add Commands here:
    	...
    	addSequential(new PIdNav(214));
    	addSequential(new ResetEncs());
    	addSequential(new DriveStraightPID(.85, 214, 2412));
